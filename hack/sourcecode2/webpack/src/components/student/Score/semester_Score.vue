  ...
  <div class="semester_Score">
    ...
    <div class="content_">
      <div class="semester_Score_top">
        ...
        <p>平均成绩绩点：{{this.perInfo.pjxfjd}}</p>
    ...
    <van-popup v-model="popShow" class="popup">
      ...
      <p>课程编号：<span>{{this.popList.kcbh}}</span></p>
      ...
      <p>成绩等级：<span>{{this.popList.cjdj}}</span></p>
      <p>成绩标识：<span>{{this.popList.cjbs}}</span></p>
      <p>是否及格：<span>{{this.popList.sfjg}}</span></p>
      <p>学分：<span>{{this.popList.credit}}</span></p>
      <p>绩点：<span>{{this.popList.jd}}</span></p>
...
.semester_Score .content_{padding: 0 20px;}
...
.best-select>div i{background: url(../../../../static/img/best.png)no-repeat center;background-size: 7px 5px;width: 7px;height: 7px;}
  .semester_Score_top{width: 100%;height: 130px;background: url(../../../../static/img/xq_bg.png)no-repeat center;background-size: 100% 100%;border-radius: 5px;box-sizing: border-box;padding:20px;}
