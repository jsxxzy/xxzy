<template>
	<div>
		<Header title="监考查询" type='0' route='/homeIndex' :casLogin="casLogin"></Header>
		...
		<div class="invi" v-else>
			<div class="content_in" v-for="(item,index) in arrList1" :key="index">
				<div class="left_box">
					...
					<span v-if="schoolCode=='4748'">
						<span>考场号：{{item.kaochanghao}}</span>
						<span>监考所属上课院系：{{item.yxmc}}</span>
					</span>
...
<style lang="less" scoped>
	...
	.invi .content_in .left_box span:nth-child(2),.content_in .left_box span:nth-child(3),.content_in .left_box span:nth-child(4){
