 <template>
  <div>
    <Header title="成绩录入审核" type="0" :route="route_params.route" :casLogin="casLogin"></Header>
    <div class="center">
...
export default {
  ...
  methods: {
    async getList() {
      this.route_params = this.$route.query.i_item
      const params = {
        cj0703id: this.route_params.ywinstanceid
      }
