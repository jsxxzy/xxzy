<template>
  <div>
    <Header v-if="schoolCode=='10013'"  title="调课审核"></Header>
    <Header v-else  title="调课审核" type="0" :route="this.$route.query.path?this.$route.query.path:'/teacher/examineIndex'" :casLogin="casLogin"></Header>
    <div class="center">
