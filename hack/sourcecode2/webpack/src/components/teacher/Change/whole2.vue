<template>
  <div class="whole2">
    ...
    <div class="P_box">
      ...
      <p v-if="!$route.query.isEx">
        <span class="fl_span">班级：</span>{{ classNames }}
      </p>
    </div>
    <div class="choice">
      <span class="m_span">
        ...
        <div>
          ...
          />
          <span
            :class="value1 == '' ? 'fr_span' : 'fr_span_act'"
      ...
      <span class="m_span" v-if="!$route.query.isEx">
        ...
        <div>
          ...
          />
          <span
            :class="value == '' ? 'fr_span' : 'fr_span_act'"
            style="display:inline-block"
          ></span>
        </div>
      </span>
      ...
      <span class="m_span">
        ...
        <div>
          ...
          />
          <span
            :class="value3 == '' ? 'fr_span' : 'fr_span_act'"
            style="display:inline-block"
          ></span>
        </div>
      </span>
      <span class="m_span">
        ...
        <div>
          ...
          />
          <span
            :class="value4 == '' ? 'fr_span' : 'fr_span_act'"
            style="display:inline-block"
          ></span>
        </div>
      </span>
      ...
      <span class="m_span" style="border:none">
        <div class="flex_item">
          <img
            src="../../../assets/images/icon_why2.png"
            alt=""
        ...
        <div>
          <input type="text" readonly class="pick-input" />
        </div>
      </span>
      <van-field
        name="fileList"
...
/* 审核人 */
.whole2 .van-picker__columns::before {
  width: 140px;
  height: 1px;
...
.whole2 .van-picker__columns::after {
  width: 140px;
  height: 1px;
  background-color: #dfe0e6;
  content: "";
...
.whole2 .person button {
  border-radius: 3px;
  padding: 5px 15px;
  margin-right: 12px;
  margin-bottom: 10px;
}
.whole2 .apply-pop .person .per-btn {
