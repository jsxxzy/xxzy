...
<style lang="less" scoped>
	.nav .router-link-exact-active.router-link-active{color: @attendance-color-1;font-weight: 600;}
	.nav .van-tab.van-tab--active .van-ellipsis{color: @attendance-color-1;font-weight: 600;}
	.nav .el-tabs__active-bar{background-color: @attendance-color-1;}
	.nav a:first-child{color: @attendance-color-1;}
