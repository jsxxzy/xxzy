<template>
  <div class="classroom-teach">
    ...
    <div class="Classroom_div">
      <span class="My_span">
        <div class="flex_item">
          <i
            ><img
              src="../../../assets/images/content_icon2.png"
              alt=""
              class="my_img"/></i
          ><span>教学周次</span>
        </div>
      ...
      <span class="My_span">
        <div class="flex_item">
          <i
            ><img
              src="../../../assets/images/date_icon2.png"
              alt=""
              class="my_img"/></i
          ><span>星期几</span>
        </div>
      ...
      <span class="My_span">
        <div class="flex_item">
          <i
            ><img
              src="../../../assets/images/people_icon2.png"
              alt=""
              class="my_img"/></i
          ><span>教室容量</span>
        </div>
      ...
      <span class="My_span">
        <div class="flex_item">
          <i
            ><img
              src="../../../assets/images/time_icon2.png"
              alt=""
              class="my_img"/></i
          ><span>起始节次</span>
        </div>
      ...
      <span class="My_span">
        <div class="flex_item">
          <i
            ><img
              src="../../../assets/images/address_icon2.png"
              alt=""
              class="my_img"/></i
          ><span>校区</span>
        </div>
      ...
      <span class="My_span">
        <div class="flex_item">
          <i
            ><img
              src="../../../assets/images/lou_icon2.png"
              alt=""
              class="my_img"/></i
          ><span>教学楼</span>
        </div>
      ...
      <span class="My_span">
        <div class="flex_item">
          <i
            ><img
              src="../../../assets/images/icon_teacher2.png"
              alt=""
              class="my_img"/></i
          ><span>教室类型</span>
        </div>
    ...
    <van-popup v-model="showPicker" position="bottom" class="qsjc">
      <van-picker
        show-toolbar
        :columns="columns"
...
export default {
  ...
  methods: {
    ...
    async getType() {
      ...
      if (this.schoolCode == "10013") {
        this.value7 = this.buildTypeList[0];
        this.typeCode = this.typeCodeList[0];
        return;
      }
      this.buildTypeList.unshift("请选择");
    },
    buildTypeSelect(val, index) {
      ...
      if (val == "请选择") {
        ...
        if (this.schoolCode == "10013") {
          this.typeCode = this.typeCodeList[index];
        }
      }
    },
    numLimit() {
    ...
    //起始节次
    onConfirm(value) {
      this.start = value[0].slice(1, 3);
      this.end = value[1].slice(1, 3);
  ...
  created() {
    if (!!sessionStorage.getItem("paramsList")) {
      var list = JSON.parse(sessionStorage.getItem("paramsList"));
      this.value1 = list.weekly;
      this.value2 = list.dayweek;
      this.value3 = list.classroomCapacity;
      this.value = list.nodeId;
      this.value6 = list.buildingName;
      this.value5 = list.campusName;
      this.weeknode = list.weeknode;
      this.xqIdList = list.campusList;
      this.value7 = list.rValue;
      this.typeCod = list.rType;
      this.jxlList = list.jxlIdList;

      this.getBuild(list.campusList)
    }
...
.classroom-teach {
  .qsjc.van-popup.van-popup--bottom {
    /deep/.van-picker-column.column1 {
      position: relative;
      &::before {
        position: absolute;
        content: "到";
    ...
    /deep/.van-picker-column.column2 {
      position: relative;
      &::after {
        position: absolute;
        content: "到";
