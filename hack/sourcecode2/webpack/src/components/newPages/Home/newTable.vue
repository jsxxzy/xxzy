...
<style lang="less">
.timetable{height: 83vh;overflow: auto;}
.black-title{margin-bottom: 10px;}
...
.timetable .single-item,.triangle-item{top: 1px;}
  ...
  .timetable .timetable_top .van-cell{background-color: @attendance-background-color-1;color: @attendance-color-3;padding: 0;width: 15%;position: relative;}
...
// WEBPACK FOOTER //
// src/components/newPages/Home/newTable.vue