...
<style lang="less">
  ...
  .msg-item{background-color: @attendance-background-color-10;border-radius: 5px;height: 82px;display: flex;align-items: center;padding: 0 20px;color: @attendance-color-1;margin-bottom: 20px;}
...
// WEBPACK FOOTER //
// src/components/newPages/Home/newMsg.vue