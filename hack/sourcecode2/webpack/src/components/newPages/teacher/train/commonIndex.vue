<template>
  <div>
    <Header title="专业培养方案" type='0' route='/homeIndex'></Header>
      ...
      <div class="content" v-if="this.type == '0'">
        <div v-for="(item, index) in pageData" :key="index">
          ...
          <ul>
            ...
            <li>总学时：{{ item.period }}</li>
            <li>开设学期：{{ item.openSemesterId }}</li>
            <li>参考周学时：{{ item.weekOfSchool }}</li>
...
// WEBPACK FOOTER //
// src/components/newPages/teacher/train/commonIndex.vue