...
//教学评价1
import Evaluate1 from "@/components/teacher/Evaluate1/evaluate";
import EvaluateSerach from "@/components/teacher/Evaluate1/evaluate2-serach";
import Evaluates1 from "@/components/teacher/Evaluate1/evaluate2";
import Evaluatess1 from "@/components/teacher/Evaluate1/evaluate3";
import EvaluatessTkjl from "@/components/teacher/Evaluate1/evaluate3-tkjl";
import EvaluatessScfj from "@/components/teacher/Evaluate1/evaluate3-scfj";
import EvaluatessQz from "@/components/teacher/Evaluate1/evaluate3-qz";
//调课申请
...
const teacherRoute = [
  ...
  {
    path: "/teacher/examine/scoreList",
    name: "scoreList",
    component: scoreList
  },
  {
  ...
  // 学风测评
  {
    ...
    name: "learnHome",
    component: () =>
      import("@/components/teacher/Evaluate/learnAssessment/home.vue")
  },
  {
    path: "/teacher/learnIndex",
    name: "learnIndex",
    component: () =>
      import("@/components/teacher/Evaluate/learnAssessment/index.vue")
  },
  {
    path: "/teacher/styleEvaluate",
    name: "styleEvaluate",
    component: () =>
      import("@/components/teacher/Evaluate/learnAssessment/style.vue")
  },
  {
    path: "/teacher/detailEvaluate",
    name: "TeaDetailEvaluate",
    component: () =>
      import("@/components/teacher/Evaluate/learnAssessment/detail.vue")
  },
  // 工作量查询
  {
  ...
  },
  {
    ...
    component: () =>
      import("@/components/teacher/class-timetable/timetable.vue")
  },
  {
    path: "/disk",
    name: "disk",
  ...
  // 考场信息查询
  {
    ...
    name: "examRoom",
    component: () => import("@/components/teacher/Examination/place/index.vue"),
    meta: {
      title: "考场信息查询"
    }
  },
  // 课表查询 演示
  {
    path: "/teacher/searchIndex",
    name: "searchIndex",
    component: () => import("@/components/teacher/TimetableQuery/index.vue"),
    meta: {
      title: "课表查询"
    }
  },
  {
    path: "/teacher/searchCondition",
    name: "searchCondition",
    component: () =>
      import("@/components/teacher/TimetableQuery/condition.vue"),
    meta: {
      title: "课表查询"
    }
  },
  {
    path: "/teacher/searchResult",
    name: "searchResult",
    component: () => import("@/components/teacher/TimetableQuery/result.vue"),
    meta: {
      title: "课表查询"
    }
  },
  // 空闲教室
  {
    path: "/restClassroom",
    name: "restClassroom",
    component: () => import("@/components/teacher/restClassroom/index.vue"),
    meta: {
      title: "今日空闲教室"
    }
  },
  {
    path: "/restDetail",
    name: "restClassroom",
    component: () => import("@/components/teacher/restClassroom/restDetail.vue"),
    meta: {
      title: "今日空闲教室"
    }
  }
