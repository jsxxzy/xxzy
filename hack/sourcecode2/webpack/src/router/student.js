...
const studentRoute = [
  ...
  },
  {
    ...
    component: () =>
      import("@/components/student/class-timetable/timetable.vue")
  },
  // 毕业状态查询
  {
    ...
    component: () =>
      import("@/components/student/SelectGraduationStatus/index.vue")
  },
  // 重修查询
  {
    path: "/student/searchRetest",
    name: "searchRetest",
    component: () => import("@/components/student/searchRetest.vue")
  }, // 学业进度
  {
    path: "/student/studyStatu",
    name: "studyStatu",
    component: () => import("@/components/student/studyStatu.vue")
  }, // 补考报名
  {
    path: "/student/registRetest",
    name: "registRetest",
    component: () => import("@/components/student/reTest/registRetest.vue")
  },
  {
    path: "/student/myRetest", 
    name: "myRetest",
    component: () => import("@/components/student/reTest/myRetest.vue")
  }
  ,
  {
    path: "/student/weixinPayMsg", 
    name: "myRetest",
    component: () => import("@/components/student/reTest/weixinPayMsg.vue")
  }
];
